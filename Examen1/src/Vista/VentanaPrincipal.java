...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuItemPais = new javax.swing.JMenuItem();
        menuItemPersona = new javax.swing.JMenuItem();
        menuArchivo = new javax.swing.JMenu();
        menuItemSimulacion = new javax.swing.JMenuItem();
        ...
        menuItemPais.setText("Pais");
        jMenu1.add(menuItemPais);

        menuItemPersona.setText("Persona");
        menuItemPersona.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuItemPersonaActionPerformed(evt);
            }
        });
        jMenu1.add(menuItemPersona);

        jMenuBar1.add(jMenu1);

        menuArchivo.setText("Simulacion");

        menuItemSimulacion.setText("Crear simulación");
        menuArchivo.add(menuItemSimulacion);

        jMenuBar1.add(menuArchivo);

        menuItemSalir.setText("Archivo");
    ...
    private javax.swing.JMenuItem menuItemPais;
    private javax.swing.JMenuItem menuItemPersona;
    private javax.swing.JMenu menuItemSalir;
    private javax.swing.JMenuItem menuItemSimulacion;
